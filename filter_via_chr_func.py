...
def filter_via_chr_func(chr, user_file_path):
    ...
    # COMMENT OUT THIS LINE...JUST DIRECTLY PASS df2 from user_file_processor() function
    ...
    # Step 2a: Determining the chromosomes that are considered in the user's exome data
    ...
    # Step 2b: Determining the user's data indices to be considered based on chr number
    if type(chr) == str:
    ...
    # Step 3: Filtering the DataFrame based on chr number
